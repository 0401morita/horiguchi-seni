...
var Home = function Home(props) {
  ...
  var handleResize = function handleResize(e) {
    ...
    timer = setTimeout(function () {
      ...
      if (messageSectionEl.current) {
        var _messageSectionHeight = messageSectionEl.current.offsetHeight || 0;

        setMessageSectionState(function (prev) {
          return Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_1__["default"])({}, prev, {
            height: _messageSectionHeight
          });
        });
      }
    }, timer);
  ...
  var handleScroll = function handleScroll() {
    ...
    if (primaryMessageEl.current) {
      console.log(messageSectionHeight);
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_3__["useEffect"])(function () {
    ...
    if (messageSectionEl.current) {
      var _messageSectionHeight2 = messageSectionEl.current.offsetHeight || 0;

      setMessageSectionState(function (prev) {
        return Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_1__["default"])({}, prev, {
          height: _messageSectionHeight2
        });
      });
    }
...
//# sourceMappingURL=index.js.c3fd4d72366a183080da.hot-update.js.map