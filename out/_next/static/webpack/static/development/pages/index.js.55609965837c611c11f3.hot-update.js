...
var Home = function Home(props) {
  ...
  var handleScroll = function handleScroll(e) {
    ...
    if (homePrimaryMessageEl.current && homeMessageSectionEl.current) {
      ...
      console.log(homePrimaryMessageTop, homeMessageSectionEl.current.offsetTop, homeMessageSectionTop + 24, scrollTop + windowHeight, windowHeight, scrollTop > windowHeight, homePrimaryMessageTop >= homeMessageSectionTop + 24);

      if (homeMessageSectionEl.current.offsetTop >= homeMessageSectionTop + 24) {
...
//# sourceMappingURL=index.js.55609965837c611c11f3.hot-update.js.map