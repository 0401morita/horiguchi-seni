...
var Home = function Home(props) {
  ...
  var handleResize = function handleResize(e) {
    ...
    timer = setTimeout(function () {
      ...
      console.log('resize', windowState, primaryState);
    }, timer);
  };
  /*
   * スクロール実行関数
  ...
  var handleScroll = function handleScroll() {
    ...
    console.log(windowState, primaryState);
    ...
    if (primaryMessageEl.current) {
      var windowWidth = windowState.width,
          ...
          vw = windowState.vw,
          vh = windowState.vh;
      var isSmartPhone = windowWidth >= 768; //console.log('isSmartPhone', isSmartPhone);

      if (isSmartPhone) {
        if (scrollTop > vh * 16 + primaryState.height) {
          document.body.classList.add('primary-fix');
        } else {
          document.body.classList.remove('primary-fix');
        }
      } else {
        if (scrollTop > vh * 8 + primaryState.height) {
          document.body.classList.add('primary-fix');
        } else {
          document.body.classList.remove('primary-fix');
        }
...
//# sourceMappingURL=index.js.5c3c772813df7fdf48b1.hot-update.js.map