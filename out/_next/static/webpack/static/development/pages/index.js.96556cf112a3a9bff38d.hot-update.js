...
var Home = function Home(props) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_3__["useEffect"])(function () {
    ...
    var offsetBottom = props.app.scrollTop + windowHeight;

    if (stopperEl.current !== null) {
      var rectTop = stopperEl.current.getBoundingClientRect().top;
      console.log(rectTop + offsetBottom);
      console.log(offsetBottom);
    }

    if (VisualMessageEl.current !== null) {
      console.log(VisualMessageEl.current);
    }
  }, [props.app.scrollTop]);
  return react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("div", {
    ...
    visualMessageRef: VisualMessageEl,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 91
    },
...
//# sourceMappingURL=index.js.96556cf112a3a9bff38d.hot-update.js.map