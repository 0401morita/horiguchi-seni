  ...
  var handleScroll = function handleScroll(e) {
    ...
    if (homePrimaryMessageEl.current && homeMessageSectionEl.current) {
      ...
      var _homePrimaryMessageEl = homePrimaryMessageEl.current.getBoundingClientRect(),
          homePrimaryMessageTop = _homePrimaryMessageEl.top,
          homePrimaryMessageBottom = _homePrimaryMessageEl.bottom,
          homePrimaryMessageHeight = _homePrimaryMessageEl.height;

      var _homeMessageSectionEl = homeMessageSectionEl.current.getBoundingClientRect(),
          homeMessageSectionTop = _homeMessageSectionEl.top,
          homeMessageSectionBottom = _homeMessageSectionEl.bottom,
          homeMessageSectionHeight = _homeMessageSectionEl.height;

      if (windowWidth >= 768) {
        var _fixPosition = hmsOffsetTop + homePrimaryMessageHeight / 2 + homeMessageSectionHeight / 2 + messageVw * 2;
      } else {
        var _fixPosition2 = hmsOffsetTop + homePrimaryMessageHeight / 2 + homeMessageSectionHeight / 2 + messageVw * 2;

        console.log(_fixPosition2, scrollBottom);
      }
...
//# sourceMappingURL=index.js.bc686a627c78ccee1bf0.hot-update.js.map