...
var Home = function Home(props) {
  ...
  var handleScroll = function handleScroll(e) {
    ...
    if (homePrimaryMessageEl.current && homeMessageSectionEl.current) {
      ...
      if (windowWidth >= 768) {
        var sectionCenter = hmsOffsetTop + homePrimaryMessageHeight / 2 + homeMessageSectionHeight / 2;
        console.log(sectionCenter, scrollBottom);
      } else {}
      /*
      console.log(
...
//# sourceMappingURL=index.js.7116fddaa96f7fb926db.hot-update.js.map