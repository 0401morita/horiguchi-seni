...
var common = __webpack_require__("G+AF");

// EXTERNAL MODULE: external "typescript-fsa-reducers"
var external_typescript_fsa_reducers_ = __webpack_require__("gCqS");

// EXTERNAL MODULE: external "typescript-fsa"
var external_typescript_fsa_ = __webpack_require__("eOz6");
var external_typescript_fsa_default = /*#__PURE__*/__webpack_require__.n(external_typescript_fsa_);

// CONCATENATED MODULE: ./src/actions/app.ts

//import { State } from '../reducers';
//import { Dispatch } from 'redux';
//import { CommonState } from '../reducers/common';
const actionCreator = external_typescript_fsa_default()();
const actions = {
...
const appReducer = Object(external_typescript_fsa_reducers_["reducerWithInitialState"])(initialState).case(actions.setApp, (state, data) => {
  return Object(objectSpread["a" /* default */])({}, state, data);
});
// CONCATENATED MODULE: ./src/reducers/service.ts

const service_initialState = {
  list: [{
...
const serviceReducer = Object(external_typescript_fsa_reducers_["reducerWithInitialState"])(service_initialState);
// EXTERNAL MODULE: external "redux-form"
var external_redux_form_ = __webpack_require__("eLzx");

// EXTERNAL MODULE: ./src/actions/wp.ts
var wp = __webpack_require__("sOzv");

// CONCATENATED MODULE: ./src/reducers/wp_posts.ts



const wp_posts_initialState = {
  isLoading: false,
  isError: false,
  data: [],
  headers: {
...
const WpPostsReducer = Object(external_typescript_fsa_reducers_["reducerWithInitialState"])(wp_posts_initialState).case(wp["a" /* actions */].setWp, (state, data) => {
  return Object(objectSpread["a" /* default */])({}, state, data);
}).case(wp["a" /* actions */].setWpPosts, (state, data) => {
  return Object(objectSpread["a" /* default */])({}, state, {
    data: data
  });
}).case(wp["a" /* actions */].setWpPostsHeaders, (state, data) => {
  return Object(objectSpread["a" /* default */])({}, state, {
    headers: data
  });
});
// CONCATENATED MODULE: ./src/reducers/wp/post.ts
...
const WpPostReducer = Object(external_typescript_fsa_reducers_["reducerWithInitialState"])(post_initialState).case(wp["a" /* actions */].setWp, (state, data) => {
  return Object(objectSpread["a" /* default */])({}, state, data);
}).case(wp["a" /* actions */].setWpPost, (state, data) => {
  return Object(objectSpread["a" /* default */])({}, state, {
    data: data
  });
});
...
/* harmony default export */ var src_reducers = (reducers);
...
// CONCATENATED MODULE: ./src/components/shares/header.tsx
...
const Header = ({
  ...
  return external_react_default.a.createElement("header", {
    ...
    className: "brand"
  }, external_react_default.a.createElement(brand["a" /* BrandIconBase */], null))), external_react_default.a.createElement("div", {
  ...
  }, "\u30B5\u30FC\u30D3\u30B9"))), external_react_default.a.createElement("li", {
    role: "menuitem"
  }, external_react_default.a.createElement(link_default.a, {
    href: "/facility"
  }, external_react_default.a.createElement("a", {
    className: "nav-menu-link"
  }, "\u65BD\u8A2D\u3068\u8A2D\u5099"))), external_react_default.a.createElement("li", {
    role: "menuitem"
  }, external_react_default.a.createElement(link_default.a, {
    href: "/entry"
  }, external_react_default.a.createElement("a", {
    className: "nav-menu-link"
  }, "\u304A\u77E5\u3089\u305B"))), external_react_default.a.createElement("li", {
    role: "menuitem"
  }, external_react_default.a.createElement(link_default.a, {
    href: "/company"
  }, external_react_default.a.createElement("a", {
    className: "nav-menu-link"
  }, "\u4F1A\u793E\u60C5\u5831"))), external_react_default.a.createElement("li", {
    className: "contact",
    role: "menuitem"
  }, external_react_default.a.createElement(link_default.a, {
    href: "/contact"
    ...
    className: "nav-menu-link"
  }, "\u304A\u554F\u3044\u5408\u308F\u305B")))))), external_react_default.a.createElement("div", {
  ...
  }, external_react_default.a.createElement("span", null), external_react_default.a.createElement("span", null)))));
};

/* harmony default export */ var header = (Header);
// CONCATENATED MODULE: ./src/actions/header.ts

 //import { CommonState } from '../reducers/common';

const header_actionCreator = external_typescript_fsa_default()(); //
// ToggleMenu
//

const header_toggleMenu = () => (dispatch, getState) => {
  dispatch(actions.setApp({
...
// CONCATENATED MODULE: ./src/containers/header.ts
...
/* harmony default export */ var containers_header = (Object(external_react_redux_["connect"])(mapStateToProps, mapDispatchToProps)(header));
// CONCATENATED MODULE: ./src/components/shares/footer.tsx
...
/* harmony default export */ var footer = (() => {
  return external_react_default.a.createElement("footer", {
    ...
    className: "title"
  }, "Company"), external_react_default.a.createElement("ul", {
    className: "footer-nav"
  }, external_react_default.a.createElement("li", null, external_react_default.a.createElement(link_default.a, {
    href: "/about"
  }, external_react_default.a.createElement("a", {
    className: "footer-nav-link"
  }, "\u5800\u53E3\u7E4A\u7DAD\u5DE5\u696D\u306B\u3064\u3044\u3066"))), external_react_default.a.createElement("li", null, external_react_default.a.createElement(link_default.a, {
    href: "/service"
  }, external_react_default.a.createElement("a", {
    className: "footer-nav-link"
  }, "\u65BD\u8A2D\u3068\u8A2D\u5099"))), external_react_default.a.createElement("li", null, external_react_default.a.createElement(link_default.a, {
    href: "/service"
  }, external_react_default.a.createElement("a", {
    className: "footer-nav-link"
  }, "\u4F1A\u793E\u60C5\u5831"))), external_react_default.a.createElement("li", null, external_react_default.a.createElement(link_default.a, {
    href: "/service"
  }, external_react_default.a.createElement("a", {
    className: "footer-nav-link"
  }, "\u304A\u77E5\u3089\u305B"))))), external_react_default.a.createElement("div", {
    className: "footer-col"
  }, external_react_default.a.createElement("h5", {
    className: "title"
  }, "Service"), external_react_default.a.createElement("ul", {
    className: "footer-nav"
  }, external_react_default.a.createElement("li", null, external_react_default.a.createElement(link_default.a, {
    href: "/about"
  }, external_react_default.a.createElement("a", {
    className: "footer-nav-link"
  }, "\u7E2B\u88FD\u30FB\u8CA9\u58F2"))), external_react_default.a.createElement("li", null, external_react_default.a.createElement(link_default.a, {
    href: "/service"
  }, external_react_default.a.createElement("a", {
    className: "footer-nav-link"
  }, "\u30E6\u30CB\u30D5\u30A9\u30FC\u30E0\u8CA9\u58F2"))), external_react_default.a.createElement("li", null, external_react_default.a.createElement(link_default.a, {
    href: "/service"
  }, external_react_default.a.createElement("a", {
    className: "footer-nav-link"
  }, "\u30EA\u30CD\u30F3\u30B5\u30D7\u30E9\u30A4"))))), external_react_default.a.createElement("div", {
    className: "footer-col"
  }, external_react_default.a.createElement("div", {
    className: "brand"
  }, external_react_default.a.createElement(brand["a" /* BrandIconBase */], null)), external_react_default.a.createElement("address", {
    className: "footer-address"
  }, external_react_default.a.createElement("p", {
    className: "address"
  }, "\u3012950-2052 \u65B0\u6F5F\u770C\u65B0\u6F5F\u5E02\u897F\u533A\u5BFA\u5C3E2-19"), external_react_default.a.createElement("div", {
    className: "tel"
  }, external_react_default.a.createElement("a", {
    href: "tel:025-269-2591"
  }, "025-269-2591")))))), external_react_default.a.createElement("p", {
    className: "copyright"
  }, "\xA9 Horiguchi, Inc."));
});
...
// CONCATENATED MODULE: ./src/components/recent_entries/item.tsx
...
const RecentPostItem = ({
  ...
  }, created, "\u30FB", category), external_react_default.a.createElement("div", {
...
/* harmony default export */ var item = (RecentPostItem);
// CONCATENATED MODULE: ./src/components/recent_entries/list.tsx




const RecentEntries = () => {
  const [posts] = Object(external_react_["useState"])([{
    title: '夏季休暇のお知らせ',
    created: '2019/10/21',
    category: 'News',
    link: '/news'
  ...
  return external_react_default.a.createElement("div", {
    ...
    return external_react_default.a.createElement(item, Object(esm_extends["a" /* default */])({}, post, {
      key: index
    }));
  })));
};

/* harmony default export */ var list = (RecentEntries);
...
const makeStore = () => {
  return Object(external_redux_["createStore"])(src_reducers, Object(external_redux_["applyMiddleware"])(external_redux_thunk_default.a));
};
...
class _app_MyApp extends app_default.a {
  constructor(...args) {
    ...
    Object(defineProperty["a" /* default */])(this, "handleScroll", () => {
      ...
      const updateState = Object(objectSpread["a" /* default */])({}, app, {
        windows: Object(objectSpread["a" /* default */])({}, app.windows, {
          scrollTop: scrollTop
        })
      });
    ...
    Object(defineProperty["a" /* default */])(this, "handleResize", () => {
      let timer = 200;
  ...
  render() {
    ...
    return external_react_default.a.createElement(next_app["Container"], null, external_react_default.a.createElement(external_react_redux_["Provider"], {
      store: store
    }, external_react_default.a.createElement(head_default.a, null, external_react_default.a.createElement("title", {
      key: "title"
    }, "\u682A\u5F0F\u4F1A\u793E \u5800\u53E3\u7E4A\u7DAD\u5DE5\u696D"), external_react_default.a.createElement("meta", {
      name: "viewport",
      ...
      className: "wrapper"
    }, external_react_default.a.createElement(containers_header, null), external_react_default.a.createElement(Component, pageProps), external_react_default.a.createElement("section", {
      ...
      className: "ja"
    }, "\u304A\u77E5\u3089\u305B"), external_react_default.a.createElement("span", {
      className: "en"
    }, "News and Column")))), external_react_default.a.createElement("div", {
      className: "col-md-7"
    }, external_react_default.a.createElement(list, null))))), external_react_default.a.createElement(footer, null)));
  }
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return getWpPostBySlug; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return getWpPosts; });
/* harmony import */ var typescript_fsa__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("eOz6");
