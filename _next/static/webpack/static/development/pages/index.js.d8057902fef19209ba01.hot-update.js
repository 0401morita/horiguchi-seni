...
var Home = function Home(props) {
  ...
  var handleScroll = function handleScroll(e) {
    ...
    if (homePrimaryMessageEl.current && homeMessageSectionEl.current) {
      ...
      if (windowWidth >= 768) {
        fixPosition = hmsOffsetTop + homePrimaryMessageHeight / 2 + homeMessageSectionHeight / 2 + messageVw * 2;
      } else {
        fixPosition = hmsOffsetTop + homePrimaryMessageHeight / 2 + homeMessageSectionHeight / 2 + messageVw * 2;
        console.log(fixPosition, scrollBottom, homeMessageSectionEl.current.style.paddingTop, getComputedStyle(homeMessageSectionEl.current).paddingTop);
      }
...
//# sourceMappingURL=index.js.d8057902fef19209ba01.hot-update.js.map