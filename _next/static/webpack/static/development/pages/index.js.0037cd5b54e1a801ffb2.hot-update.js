...
var Home = function Home(props) {
  ...
  var handleScroll = function handleScroll(e) {
    ...
    if (homePrimaryMessageEl.current && homeMessageSectionEl.current) {
      ...
      console.log(homePrimaryMessageTop, homeMessageSectionTop + 24, homePrimaryMessageTop >= homeMessageSectionTop + 24);
      console.log(Math.floor(homePrimaryMessageBottom) + scrollTop + vw + 24, scrollTop + windowHeight, Math.floor(homePrimaryMessageBottom) + scrollTop + vw + 24 > scrollTop + windowHeight);

      if (homePrimaryMessageTop >= homeMessageSectionTop + 24) {
...
//# sourceMappingURL=index.js.0037cd5b54e1a801ffb2.hot-update.js.map